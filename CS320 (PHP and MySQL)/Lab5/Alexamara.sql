...
DROP TABLE IF EXISTS ALEXAMARA_MARINA;
DROP TABLE IF EXISTS ALEXAMARA_MARINA_SLIP;
DROP TABLE IF EXISTS ALEXAMARA_OWNER;
DROP TABLE IF EXISTS ALEXAMARA_SERVICE_CATEGORY;
DROP TABLE IF EXISTS ALEXAMARA_SERVICE_REQUEST;

CREATE TABLE ALEXAMARA_MARINA
...
STATE CHAR(2),
ZIP CHAR(5) );
CREATE TABLE ALEXAMARA_MARINA_SLIP
...
STATE CHAR(2),
ZIP CHAR(5) );
CREATE TABLE ALEXAMARA_SERVICE_CATEGORY
(CATEGORY_NUM DECIMAL(4,0) PRIMARY KEY,
CATEGORY_DESCRIPTION CHAR(255) );
CREATE TABLE ALEXAMARA_SERVICE_REQUEST
...
INSERT INTO ALEXAMARA_SERVICE_CATEGORY
VALUES
...
INSERT INTO ALEXAMARA_SERVICE_REQUEST
VALUES
