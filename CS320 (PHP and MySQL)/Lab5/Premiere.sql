...
DROP TABLE IF EXISTS PREMIERE_REP;
DROP TABLE IF EXISTS PREMIERE_CUSTOMER;
DROP TABLE IF EXISTS PREMIERE_ORDERS;
DROP TABLE IF EXISTS PREMIERE_PART;
DROP TABLE IF EXISTS PREMIERE_ORDER_LINE;

CREATE TABLE PREMIERE_REP
...
RATE DECIMAL(3,2) );
CREATE TABLE PREMIERE_CUSTOMER
...
REP_NUM CHAR(2) );
CREATE TABLE PREMIERE_ORDERS
(ORDER_NUM CHAR(5) PRIMARY KEY,
ORDER_DATE DATE,
CUSTOMER_NUM CHAR(3) );
CREATE TABLE PREMIERE_PART
...
WAREHOUSE CHAR(1),
PRICE DECIMAL(6,2) );
CREATE TABLE PREMIERE_ORDER_LINE
(ORDER_NUM CHAR(5),
PART_NUM CHAR(4),
NUM_ORDERED DECIMAL(3,0),
QUOTED_PRICE DECIMAL(6,2),
PRIMARY KEY (ORDER_NUM, PART_NUM) );
INSERT INTO PREMIERE_REP
VALUES
...
INSERT INTO PREMIERE_ORDER_LINE
VALUES
('21608','AT94',11,21.95);
INSERT INTO PREMIERE_ORDER_LINE
VALUES
